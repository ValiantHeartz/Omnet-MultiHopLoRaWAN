 ...
 *     double y;
 *     int lastActionTime;
 *     int networkingToSonFlagMsg;
 *     int networkingToSonFlagSelectedId;
...
class wmsg : public ::omnetpp::cPacket
{
  protected:
    ...
    int networkingToSonFlagMsg = 0;
    int networkingToSonFlagSelectedId = 0;
  ...
  public:
    ...
    virtual int getNetworkingToSonFlagMsg() const;
    virtual void setNetworkingToSonFlagMsg(int networkingToSonFlagMsg);

    virtual int getNetworkingToSonFlagSelectedId() const;
    virtual void setNetworkingToSonFlagSelectedId(int networkingToSonFlagSelectedId);

    virtual int getSourcePacketLength() const;
    virtual void setSourcePacketLength(int sourcePacketLength);

    virtual double getBackwardScore() const;
    virtual void setBackwardScore(double backwardScore);
};
